/*
  ...
  1. New Tables
    - `app_users` - User information (separate from auth.users)
    - `user_donations` - Donation transactions
    - `donation_certificates` - ASA certificates
    - `user_chats` - Chat conversations
