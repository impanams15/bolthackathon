/*
  # Create new tables for donation system
...
-- Create donations table (separate from existing donations table)
...
-- Create chats table (separate from existing chat_conversations table)
